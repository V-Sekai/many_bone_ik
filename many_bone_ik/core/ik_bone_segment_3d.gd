...
var child_segments: Array = [] # Contains only direct child chains that end with effectors or have child that end with effectors
var parent_segment
var root_segment
var effector_list: Array = []
var target_headings: PackedVector3Array
var tip_headings: PackedVector3Array
var tip_headings_uniform: PackedVector3Array
var heading_weights: Array = []
var skeleton = null
var pinned_descendants: bool = false
var previous_deviation: float = INF
var default_stabilizing_pass_count: int = 0 # Move to the stabilizing pass to the ik solver. Set it free.
var bone_map: Dictionary = {}

func _has_pinned_descendants() -> bool:
    return false

func _enable_pinned_descendants():
    pass

func _update_target_headings(p_for_bone, r_weights, r_htarget):
    pass

func _update_tip_headings(p_for_bone, r_heading_tip):
    pass

func _set_optimal_rotation(p_for_bone, r_htip, r_heading_tip, r_weights, p_dampening = -1, p_translate = false, p_constraint_mode = false, current_iteration = 0, total_iterations = 0):
    pass

func _qcp_solver(p_damp, p_default_damp, p_translate, p_constraint_mode, p_current_iteration, p_total_iterations):
    pass

func _update_optimal_rotation(p_for_bone, p_damp, p_translate, p_constraint_mode, current_iteration, total_iterations):
    pass

func _get_manual_msd(r_htip, r_htarget, p_weights) -> float:
    return 0.0

func _is_parent_of_tip(p_current_tip, p_tip_bone) -> bool:
    return false

func _has_multiple_children_or_pinned(r_children, p_current_tip) -> bool:
    return false

func _process_children(r_children, p_current_tip, r_pins, p_root_bone, p_tip_bone, p_many_bone_ik):
    pass

func _create_child_segment(p_child_name, p_pins, p_root_bone, p_tip_bone, p_many_bone_ik, p_parent):
    return null

func _create_next_bone(p_bone_id, p_current_tip, p_pins, p_many_bone_ik):
    return null

func _finalize_segment(p_current_tip):
    pass

func update_pinned_list(r_weights):
    pass

static func clamp_to_cos_half_angle(p_quat, p_cos_half_angle):
    pass

static func recursive_create_headings_arrays_for(p_bone_segment):
    pass

func create_headings_arrays():
    pass

func recursive_create_penalty_array(p_bone_segment, r_penalty_array, r_pinned_bones, p_falloff):
    pass

func segment_solver(p_damp, p_default_damp, p_constraint_mode, p_current_iteration, p_total_iteration):
    pass
...
func get_child_segments() -> Array:
    return []

func create_bone_list(p_list, p_recursive = false, p_debug_skeleton = false) const:
    pass

func get_ik_bone(p_bone) const:
    return null

func generate_default_segments(p_pins, p_root_bone, p_tip_bone, p_many_bone_ik):
    pass
