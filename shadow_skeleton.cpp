...
// 	Ref<AbstractAxes> freeCopy = getLocalMBasis();
// 	freeCopy->markDirty();
// 	freeCopy->updateGlobal();
// 	return freeCopy;
// }

// Transform AbstractAxes::attachedCopy(bool p_slipAware) {
// 	updateGlobal();
// 	Transform copy;
// 	copy.basis = getGlobalMBasis();
// 	copy.origin = getParentAxes();
// 	if (!p_slipAware) {
// 		copy.setSlipType(IGNORE);
// 	}
// 	copy.basis = localMBasis;
// 	copy.markDirty();
// 	return copy;
// }
...
// Ref<AbstractAxes> AbstractAxes::getLocalOf(Ref<AbstractAxes> input) {
// 	// TODO Auto-generated method stub
// 	return nullptr;
// }
